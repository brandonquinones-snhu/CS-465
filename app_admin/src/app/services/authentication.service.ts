...
export class AuthenticationService {
  ...
  public getToken(): string {
    ...
    if(!out)
      {
        console.log("authentication.service.ts - getToken() no token!")
        return '';
      }
    console.log("authentication.service.ts - getToken() successful")
    console.log(out)
    return out;
  }
  ...
  public saveToken(token: string): void {
    ...
    console.log("authentication.service.ts - saveToken(token)")
  }
...
public isLoggedIn(): boolean {
    ...
    console.log("authentication.service.ts - isLoggedIn()")
    if (token) {
  ...
  public getCurrentUser(): User {
    ...
    console.log("auth service - getCurrentUser()")
